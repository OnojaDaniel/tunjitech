...
<aside class="sidebar">
    ...
    <div>
        <a href="index.html" class="sidebar-logo">
            ...
            <img src="../assets/images/tunjitech-logo-icon.png" alt="site logo" class="logo-icon">
        </a>
    </div>
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li>
                <a class="nav-link" href="all_alerts">
                    <iconify-icon icon="mdi:information" class="menu-icon"></iconify-icon>
                ...
                <a class="nav-link" href="messages">
                    <iconify-icon icon="mdi:chat" style="font-size: 24px;"></iconify-icon>
                   <span>Chat</span>
                </a>
            </li>
